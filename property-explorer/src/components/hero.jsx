function hero(){
    return(
        <div className = "grid grid-cols-1 md:grid-cols-[700px_580px] max-w-full  ">
            <div >
                <h1 className="text-3xl md:text-5xl font-bold text-blue-950 leading-12 text-center md:text-left w-full">
                    Enhance Your Sales
                    <br />Funnel with Real
                    <br />
                    Estate CRM in UAE
                </h1>
                <div className="mt-4 leading-8 md:leading-relaxed w-[95%] mx-auto md:w-[100%] text-sm text-center md:text-left md:text-lg md:translate-x-1 ">
                    <p>
                ...
                <div className="mt-4 flex flex-row gap-4 translate-x-1 justify-center md:justify-start">
                    ...
                    <a href="#" className="hidden md:inline-flex rounded-2xl bg-white text-green-700 border border-green-700 py-3 px-5 shadow-[0_0_30px_rgba(56,189,248,0.25)] text-center ">
                        Book Free Demo
                    </a>
